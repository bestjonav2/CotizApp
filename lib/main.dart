...
class _MyHomePageState extends State<MyHomePage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
                ...
                Container(
                  ...
                  child: Container(
                    ...
                    child: Column(
                      ...
                      children: <Widget>[
                        Text('CotizApp', style: titleStyleWhite,)
                      ],
                    ),
                  ),
                ),
      ...
      floatingActionButton: FloatingActionButton(
        onPressed: () {
          Navigator.of(context).push(MaterialPageRoute(builder: (context) => HelloWorld()));
        },
  ...
  List<Cotization> findJobs() {
    ...
    for (int i = 0; i < 10; i++) {
      cotizations.add(new Cotization("MS-7877", "Pieza de motor de audi R8", 420.69, new AssetImage("assets/img/images.png")));
    }
    return cotizations;
  }
          ...
          Column(
            children: <Widget>[
              ...
              Container(
                ...
                child: FittedBox(
                  child: Image.network("https://encrypted-tbn0.gstatic.com/images?q=tbn%3AANd9GcSGOd0cIAPhNTV8HXnfsgIm8MLGB2SkgTtXrzP4qCnwD7dhSZhZ"),
                  fit: BoxFit.cover,
                ),
              ),
              Text(
